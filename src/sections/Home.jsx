  ...
  return (
    <section>
      ...
      <div  className=" min-h-screen flex flex-col justify-center items-center bg-linear-to-r from-white to-yellow-700 text-center px-4  bg-cover bg-center relative ">
        ...
        <img src="/images/cookie.png"  className="cookie-left absolute top-20 left-5 w-[200px]" alt="" />
        <img src="/images/cookie.png"  className="cookie-right absolute  bottom-20 right-5 w-[200px]"alt="" />

        <img src="/images/drinks.png"  className="drink-left absolute  bottom-20 left-10 w-[200px]" alt="" />
         <img src="/images/drinks.png"  className="drink-right absolute top-20 right-10 w-[200px]" alt="" />
        </div>
        ...
        <div className="w-150 bg-white/5 backdrop-blur-sm p-10 rounded-3xl shadow-[0_0_40px_rgba(255,255,255,0.3)]">
          ...
          {/* Call to Action */}
          <button className="bg-yellow-900 hover:bg-yellow-800 text-white px-8 py-3 rounded-lg font-medium shadow-lg transition-all duration-300">
            Learn More...
          </button>
        </div>
      </div>
